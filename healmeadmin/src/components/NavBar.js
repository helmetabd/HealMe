            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <div className='borderLogo'>
                    <a class="navbar-brand" href="#">
                        <img src={logo} alt="Logo" width="100" height="50" class="d-inline-block align-text-center"/>
                        Admin
                    </a>
                </div>
                ...
                <ul className="navbar-nav nav nav-pills justify-content-end mb-2 mb-lg-0 ">
                    <li className="nav-item m-1">
                        ...
                        ? <NavLink className={({isActive}) => (!isActive ? "nav-link bg-primary" : "nav-link")} aria-current="page" to="/login">Login</NavLink> 
                        : <NavLink className={({isActive}) => (!isActive ? "nav-link bg-primary" : "nav-link")} aria-current="page" to="/" onClick={() => localStorage.removeItem("Authorization")}>Logout</NavLink>}
                    </li>    
                </ul>
